...
Lena is preparing for an important coding competition that is preceded by N sequential preliminary contests. She believes in "saving luck", and wants to check her theory. Each 
contest is described by two integers, Li and Ti:

1. Li is the amount of luck that can be gained by winning the contest. If Lena wins the contest, her luck balance will decrease by Li; if she loses it, her luck balance will increase 
   by Li.
...
Explanation
There are N=6 contests. Of these contests, 4 are important (so she cannot lose any more than K=3 of them). Lena maximizes her luck if she wins the 3rd important contest (where Li=1) 
