...
The first line contains an integer N. Then N lines follow. Each line has the name Si of the menu and its price Pi separated by a single space.
Output
