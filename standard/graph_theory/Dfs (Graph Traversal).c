...
#include<stdio.h>
#include<assert.h>
#define maxVertices   100  /* maxVertices represents maximum number of vertices that can be present in the graph. */
...
int main()
{
	int graph[maxVertices][maxVertices],size[maxVertices]={0},visited[maxVertices]={0};
        int vertices,edges,iter;  /* vertices represent number of vertices and edges represent number of edges in the graph. */ 
