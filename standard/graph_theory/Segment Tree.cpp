...
int *constructST(int arr[], int n)
{
    ...
    int x = ceil(log2(n)); //Height of segment tree
    int max_size = 2*pow(2, x) - 1; //Maximum size of segment tree
    int *st = new int[max_size]; //int* st=(int*)calloc(max_size,sizeof(int));
